  ...
  <div class="grid gap-3 grid-cols-12">
    ...
    <div class="mt-3 col-span-3">
      ...
      <select
        ...
        v-model="model.type"
        @change="typeChange"
        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm sm:text-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
      >
...
// check if field type should have options
...
function dataChange() {
  // use JSON to clone the data otherwise options will be lost when select onchange kicks in
